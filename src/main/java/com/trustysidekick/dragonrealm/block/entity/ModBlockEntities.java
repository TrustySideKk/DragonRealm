...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<TestBlockEntity> TEST_BLOCK_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(DragonRealm.MOD_ID, "test_block_be"), FabricBlockEntityTypeBuilder.create(TestBlockEntity::new, ModBlocks.TEST_BLOCK).build());
